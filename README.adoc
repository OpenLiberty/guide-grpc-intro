...
----
cd finish
mvn -pl systemproto protobuf:compile
mvn -pl systemproto protobuf:compile-custom
----

Update the generated `SystemServiceGrpc` class in the `target` directory.

[role="command hotspot file=0", subs="quotes"]
----
systemproto/target/generated-sources/protobuf/grpc-java/io/openliberty/guides/systemproto/SystemServiceGrpc.java
----

SystemServiceGrpc.java
[source, java, linenums, role='code_column', file=1]
----
include::finish/systemproto/target/generated-sources/protobuf/grpc-java/io/openliberty/guides/systemproto/SystemServiceGrpc.java[]
----

Replace the [hotspot=generated file=0]`@javax.annotation.Generated` annotation by the `@jakarta.annotation.Generated` annotation.

Run the following command to compile the generated gRPC classes and build the jar file.
[role='command']
----
...
The [hotspot=getBidirectProperties file=0]`getBidirectProperties` RPC defines the bidirectional streaming call. In this service, the client service streams `SystemPropertyName` messages to the server service. The server service returns a stream of [hotspot=SystemProperty file=0]`SystemProperty` messages.
...
Run the following commands to generate the gRPC classes.
[role='command']
----
mvn -pl systemproto protobuf:compile
mvn -pl systemproto protobuf:compile-custom
...
Because the application in this guide uses JakartaEE 9, you need to update the `SystemServiceGrpc` generated class to use the `@jakarta.annotation.Generated` annotation.
...
SystemServiceGrpc.java
[source, java, linenums, role='code_column', file=2]
----
include::finish/systemproto/target/generated-sources/protobuf/grpc-java/io/openliberty/guides/systemproto/SystemServiceGrpc.java[]
----

Replace the [hotspot=generated file=2]`@javax.annotation.Generated` annotation by the `@jakarta.annotation.Generated` annotation.
