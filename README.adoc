...
SystemService.java
[source, Java, linenums, indent=0, role="code_column hide_tags=copyright,getServerStreamingProperties,getClientStreamingProperties,getPropertiesBidirect"]
----
...
----
SystemService.java
[source, Java, linenums, indent=0, role="code_column hide_tags=copyright,getClientStreamingProperties,getPropertiesBidirect"]
----
include::finish/system/src/main/java/io/openliberty/guides/system/SystemService.java[]
----
