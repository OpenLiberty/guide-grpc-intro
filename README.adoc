...
The application that you will build in this guide consists of three projects, the `systemproto` model project, the `query` client service project, and the `system` server service project. 
