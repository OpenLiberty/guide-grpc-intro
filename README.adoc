...
In this section, you'll create unit tests for the gRPC server service by using JUnit and Mockito, and integration tests for the `query` service.

=== Creating unit tests for the gRPC server service
