...
=== Creating tests for the system service

// Create SystemIT.java
[role="code_command hotspot file=0", subs="quotes"]
----
#Create the `SystemIT` class.#
`system/src/test/java/it/io/openliberty/guides/system/SystemIT.java`
----

SystemIT.java
[source, Java, linenums, indent=0, role="code_column hide_tags=copyright"]
----
include::finish/system/src/test/java/it/io/openliberty/guides/system/SystemIT.java[]
----
...
=== Creating tests for the query service
...
Press the `enter/return` key to run the test from the command-line session where you started the system service.
...
Next, press the `enter/return` key to run the test from the command-line session where you started the query service.
